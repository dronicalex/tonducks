...
window.addEventListener('scroll', function () {
	...
	for (let index = 0; index < monets.length; index++) {
		...
		element.style.transform = "translate( 0px, " + (y / 14) + "px)"
	}
...
// -------------------------timer---------------------
let endDate = new Date("May 12, 2022 09:00:00").getTime();
...
let imgg = document.querySelectorAll('.option__block div');
let information = document.querySelectorAll('.option__text');
let imggBlock = document.querySelectorAll('.option__div');


for (let index = 0; index < imggBlock.length; index++) {
	const element = imggBlock[index];
	element.addEventListener('mousemove', function () {
		for (let index = 0; index < information.length; index++) {
			const element = information[index];
			element.classList.remove('_active')
		}
		information[index].classList.add('_active')
		for (let index = 0; index < imgg.length; index++) {
			const element = imgg[index];
			element.style.filter = 'grayscale(100%)'
		}
		imgg[index].style.filter = 'grayscale(0%)'
	})
...
// let as = document.querySelectorAll('.option__change')
...
// let aaa = document.querySelectorAll('.option__atr')
...
let mass = [
	document.querySelectorAll('.option__ruki img'),
	document.querySelectorAll('.option__glaza img'),
	document.querySelectorAll('.option__golova img'),
	document.querySelectorAll('.option__kliuv img'),
	document.querySelectorAll('.option__telo img'),
	document.querySelectorAll('.option__tsvet-tela img')]

console.log(mass)
let rukie = document.querySelectorAll('.option__change');
for (let i = 0; i < mass.length; i++) {
	const element = mass[i];
	for (let index = 0; index < element.length; index++) {
		if (element[index] == element[0]) {
			element[index].classList.add('_active')
		}
...
for (let index = 0; index < rukie.length; index++) {
	const element = rukie[index];
	element.addEventListener('click', function () {
		for (let i = 0; i < mass.length; i++) {
			// const element = mass[index];
			if (i == index) {
				console.log(mass[i])
				for (let ind = 0; ind < mass[i].length; ind++) {

					if (mass[i][ind].classList.contains('_active')) {
						console.log([ind],)
						console.log(mass[i])
						if ([ind] == mass[i].length - 1) {
							mass[i][ind].classList.remove('_active')
							mass[i][0].classList.add('_active')
							return
						} else {
							// console.log(mass[i][ind])
							mass[i][ind].classList.remove('_active')
							mass[i][ind + 1].classList.add('_active')
							return
						}
					}
...
// for (let index = 0; index < ruki.length; index++) {
// 	const element = ruki[index];
// 	if (element == ruki[0]) {
...
// rukie.addEventListener('click', function () {
// 	for (let index = 0; index < ruki.length; index++) {
// 		const element = ruki[index];
// 		if (element.classList.contains('_active')) {
// 			if (index == ruki.length - 1) {
// 				element.classList.remove('_active')
// 				ruki[0].classList.add('_active')
// 				return
// 			} else {
// 				element.classList.remove('_active')
// 				ruki[index + 1].classList.add('_active')
// 				return
// 			}
